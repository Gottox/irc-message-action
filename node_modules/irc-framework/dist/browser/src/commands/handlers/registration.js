...
var handlers = {
  ...
  RPL_ISUPPORT: function RPL_ISUPPORT(command, handler) {
    ...
    for (i = 1; i < options.length; i++) {
      ...
      option[0] = option[0].toUpperCase(); // https://datatracker.ietf.org/doc/html/draft-brocklesby-irc-isupport-03
  ...
  AUTHENTICATE: function AUTHENTICATE(command, handler) {
    ...
    var b64 = b.toString('base64'); // https://ircv3.net/specs/extensions/sasl-3.1#the-authenticate-command
