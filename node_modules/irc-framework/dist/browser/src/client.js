...
module.exports = /*#__PURE__*/function (_EventEmitter) {
  ...
  _createClass(IrcClient, [{
    ...
    value: function startPeriodicPing() {
      ...
      client.command_handler.on('pong', resetPingTimer); // Socket has disconnected, remove 'pong' listener until next 'registered' event
    ...
    value: function caseLower(string) {
      ...
      for (var i = 0; i < string.length; i++) {
        var charCode = string.charCodeAt(i); // ASCII character from 'A' to upper bound defined above
